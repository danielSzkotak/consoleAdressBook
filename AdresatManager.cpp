...
void AdresatManager::dodajAdresata() {
    ...
    if (plikZAdresatami.dopiszAdresataDoPliku(adresat))
        ...
        cout << endl << "Nie uda³o siê dodaæ adresata do pliku" << endl << endl;
    system("pause");
            ...
            if (itr->pobierzId() == idUsuwanegoAdresata){
                ...
                if (znak == 't'){                                       
                    ...
                    if (plikZAdresatami.usunAdresataZPliku(idUsuwanegoAdresata)) {
                        ...
                        cout << endl << endl << "Bload usuwania adresata z pliku" << endl << endl;
                        system("pause");
                    }
...
void AdresatManager::edytujAdresata()
{
    ...
    if (czyIstniejeAdresat == true) {
        ...
        if (plikZAdresatami.edytujDaneAdresataWPliku(idEdytowanegoAdresata, adresat, ID_ZALOGOWANEGO_UZYTKOWNIKA)) {

            cout << endl << endl << "Ustawiono nowe dane adresata" << endl << endl;
            system("pause");

        }
        else {

            cout << endl << endl << "Bload edytowania adresata w pliku" << endl << endl;
            system("pause");
        }
    }
    else {
